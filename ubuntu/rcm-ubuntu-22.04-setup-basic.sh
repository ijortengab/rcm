...
Variation Basic
Version `RcmUbuntu2204SetupBasic_printVersion`
...
# Help and Version.
[ -n "$help" ] && { RcmUbuntu2204SetupBasic_printHelp; exit 1; }
[ -n "$version" ] && { RcmUbuntu2204SetupBasic_printVersion; exit 1; }
...
_ 'Version '; yellow `RcmUbuntu2204SetupBasic_printVersion`; _.
____
