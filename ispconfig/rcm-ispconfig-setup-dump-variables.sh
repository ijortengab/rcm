...
# Functions.
[[ $(type -t RcmIspconfigSetupDumpVariables_printVersion) == function ]] || RcmIspconfigSetupDumpVariables_printVersion() {
    echo '0.1.0'
}
[[ $(type -t RcmIspconfigSetupDumpVariables_printHelp) == function ]] || RcmIspconfigSetupDumpVariables_printHelp() {
    cat << EOF
RCM ISPConfig Setup
Variation Dump Variables
Version `RcmIspconfigSetupDumpVariables_printVersion`
...
# Help and Version.
[ -n "$help" ] && { RcmIspconfigSetupDumpVariables_printHelp; exit 1; }
[ -n "$version" ] && { RcmIspconfigSetupDumpVariables_printVersion; exit 1; }
...
[[ $(type -t websiteCredentialIspconfig) == function ]] || websiteCredentialIspconfig() {
...
_ 'Version '; yellow `RcmIspconfigSetupDumpVariables_printVersion`; _.
____
