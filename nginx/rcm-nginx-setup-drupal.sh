...
# Functions.
[[ $(type -t RcmNginxSetupDrupal_printVersion) == function ]] || RcmNginxSetupDrupal_printVersion() {
    echo '0.1.0'
}
[[ $(type -t RcmNginxSetupDrupal_printHelp) == function ]] || RcmNginxSetupDrupal_printHelp() {
    cat << EOF
RCM Nginx Setup
Variation Drupal
Version `RcmNginxSetupDrupal_printVersion`
...
# Help and Version.
[ -n "$help" ] && { RcmNginxSetupDrupal_printHelp; exit 1; }
[ -n "$version" ] && { RcmNginxSetupDrupal_printVersion; exit 1; }
...
_ 'Version '; yellow `RcmNginxSetupDrupal_printVersion`; _.
____
