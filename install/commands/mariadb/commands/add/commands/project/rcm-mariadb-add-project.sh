...
# Title.
title rcm mariadb add project
____

# Dependency.
require command mysql
require command pwgen
require rcm mariadb add database
require rcm mariadb add user
require rcm mariadb assign grant-all
