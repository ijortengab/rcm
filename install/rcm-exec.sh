...
# Help and Version.
[ -n "$help" ] && { usage; exit 0; }
[ -n "$version" ] && { e $RCM_VERSION; x; }

# Require.
require vendor/ijortengab/rcm/functions/base/echo-wrap.sh
...
require vendor/ijortengab/rcm/functions/base/echo-wrap-multiline.sh
require vendor/ijortengab/rcm/functions/base/read-true.sh
require vendor/ijortengab/rcm/functions/base/read-false.sh
require vendor/ijortengab/rcm/functions/base/print-select-dialog.sh
require vendor/ijortengab/rcm/functions/base/print-select-other-dialog.sh
require vendor/ijortengab/rcm/functions/base/spinning-dot.sh
