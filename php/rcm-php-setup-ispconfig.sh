...
# Functions.
[[ $(type -t RcmPhpSetupIspconfig_printVersion) == function ]] || RcmPhpSetupIspconfig_printVersion() {
    echo '0.1.0'
}
[[ $(type -t RcmPhpSetupIspconfig_printHelp) == function ]] || RcmPhpSetupIspconfig_printHelp() {
    cat << EOF
RCM PHP Setup
Variation ISPConfig
Version `RcmPhpSetupIspconfig_printVersion`
...
# Help and Version.
[ -n "$help" ] && { RcmPhpSetupIspconfig_printHelp; exit 1; }
[ -n "$version" ] && { RcmPhpSetupIspconfig_printVersion; exit 1; }
...
_ 'Version '; yellow `RcmPhpSetupIspconfig_printVersion`; _.
____
